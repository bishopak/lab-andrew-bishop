...
viewStudentResponse = WS.sendRequestAndVerify(findTestObject('students/View students', [('authToken') : GlobalVariable.authToken
            , ('clientId') : GlobalVariable.userName]))

WS.verifyResponseStatusCode(viewStudentResponse, 200)
